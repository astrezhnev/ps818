...
election %>% ggplot(aes(x=pctWhiteNH, y=voteshare)) + geom_point(alpha=.2, size=.7) + geom_smooth(method="lm", se=F) + theme_bw() + xlab("Percent non-Hispanic white") + ylab("Clinton vote share (%)")
```
