...
### In-person Midterms (50%)

We will have two in-person midterm examinations on **Wednesday, October 28th, 2026**.  The exam will take the form of a standard pen-and-paper timed examination involving both theory and practical analysis of sample code and results.

### Replication project (30%)

Students will complete a replication project and present their results in the form of a poster. 
...
Unless you have strong preferences for a specific coding environment, I also highly recommend that you use either the free [RStudio](https://rstudio.com) Desktop Integrated Development Environment (IDE) or the [Positron](https://positron.posit.co/) IDE. Both are designed to give you a simple and easy-to-use environment for editing code and are built with data science in mind. These IDEs also make it very easy to write and compile Quarto documents: the format in which the problem sets will be distributed. In my experience, RStudio is still a bit better with regards to how it handles the editing and previewing of these documents, but recent updates to Positron have made it a reasonable alternative.
